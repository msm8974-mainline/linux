...
int __qcom_scm_iommu_secure_ptbl_size(struct device *dev, u32 _spare,
				      size_t *size)
{
	__le32 spare = 0;
	__le32 resp[2];
	...
	ret = qcom_scm_call(dev, QCOM_SCM_SVC_MP,
			    ...
			    &spare, sizeof(spare), &resp, sizeof(resp));
				      ...
				      u32 spare)
{
	...
	args.addr = cpu_to_le32(addr);
	args.size = cpu_to_le32(size);
	args.spare = 0;
