...
static struct snd_soc_component_driver soc_component_dev_stereo_tfa9890;
...
static int tfa9890_set_stereo_dai_sysclk(struct snd_soc_dai *component_dai,
...
static int tfa9890_stereo_dev_probe(struct platform_device *pdev)
{
	...
	return snd_soc_register_component(&pdev->dev,
		&soc_component_dev_stereo_tfa9890,
...
static const struct of_device_id tfa9890_stereo_component_dt_match[] = {
...
static struct platform_driver tfa9890_stereo_driver = {
	.driver = {
		...
		.owner = THIS_MODULE,
		.of_match_table = tfa9890_stereo_component_dt_match,
	},
